...
import com.gcores.radionews.ui.view.base.adapter.HomeNewsAdapter;
...
public class NewsFragment extends AppFragment implements OnRefreshListener, OnLoadMoreListener {
...
//        mHeanderView = inflater.inflate(R.layout.view_item_header,null);
        ...
        mNewsAdapter = new HomeNewsAdapter(mArticleItems, getActivity());
...
//          mHomeItemAdapter.disableLoadMoreIfNotFullPage(topList);
        topList.setAdapter(mNewsAdapter);
...
//                mHomeSimpleAdapter.addData(itemHome);
        ...
        if (current_counter < TOTAL_COUNTER) {
            ...
            mNewsAdapter.loadMoreEnd(isRefresh);
